...
def getJusticeOneDirection(df_sel, X_sel):
    y_sel = ['justice1Direction']
...
def getWinningProbability(df_sel, X_sel):
    ...
    rfc = RandomForestClassifier(n_estimators=50, max_depth=None,criterion='entropy')
...
def main():
    ...
    columns_to_select = ['caseId','caseName','issue','issueArea','partyWinning','petitioner','respondent','jurisdiction','threeJudgeFdc','lcDisagreement','lcDisposition','caseOrigin','caseSource','decisionDirection','splitVote','majVotes','minVotes',
    ...
    print df_sel
    # X_sel1 = ['issue','issueArea','caseId','justice1Code',]
    # getJusticeOneDirection(df_sel,X_sel1)
    ...
    caseNAMES = []
    for c in caseIDs:
        for k, d in enumerate(df_sel['caseId']):
            if (d==c):
                caseNAMES.append(df_sel['caseName'][k])
                # caseNAMES.append()
    ...
    output.to_csv('/Users/anaygupta/version1/data/predict_output.csv')
    # print p9
    # print gt9
