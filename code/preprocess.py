...
scotus = df[['caseId','caseName','issue','issueArea','decisionDirection','splitVote','majVotes','minVotes','petitioner','respondent','jurisdiction','threeJudgeFdc','caseOrigin','caseSource','lcDisagreement','lcDisposition','lcDispositionDirection']]
