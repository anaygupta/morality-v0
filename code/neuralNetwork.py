...
def getWinningProbability(df_sel, X_sel):
    ...
    clf = MLPClassifier(solver = 'sgd',alpha=1e-5,hidden_layer_sizes=(50,),learning_rate='constant', max_iter = 300)
...
def main():
    ...
    columns_to_select = ['caseId','issue','issueArea','partyWinning','petitioner','respondent','jurisdiction','threeJudgeFdc','lcDisagreement','lcDisposition','caseOrigin','caseSource','decisionDirection','splitVote','majVotes','minVotes',
    ...
    X_sel = ['caseId','issue','issueArea','justice1Code','justice2Code','justice3Code','justice4Code','justice5Code','justice6Code','justice7Code','justice8Code','justice9Code','justice1Direction','justice2Direction','justice3Direction','justice4Direction','justice5Direction','justice6Direction','justice7Direction','justice8Direction','justice9Direction','petitioner','respondent','jurisdiction','threeJudgeFdc','lcDisagreement','lcDisposition','caseOrigin','caseSource']
